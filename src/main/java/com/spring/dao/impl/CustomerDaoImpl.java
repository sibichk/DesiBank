...
public class CustomerDaoImpl extends HibernateDaoSupport implements CustomerDao {
	...
	public String persistCustomer(CustomerForm customer) {
		...
		questionanswer.setQuestion(customer.getQuestion2());
		questionanswer.setAnswer(customer.getAnswer2());
		questionanswer.setUserid(customer.getUserid());
		getHibernateTemplate().save(questionanswer);
	...
	public List<SecurityQuestions> securityQns() {
		...
		List<SecurityQuestions> securityQuestions = (List<SecurityQuestions>)getHibernateTemplate().find("from SecurityQuestions sq where sq.qid < 6");
	...
	public List<SecurityQuestions> securityQns2() {
		@SuppressWarnings("unchecked")
		List<SecurityQuestions> securityQuestions = (List<SecurityQuestions>)getHibernateTemplate().find("from SecurityQuestions sq where sq.qid > 5");

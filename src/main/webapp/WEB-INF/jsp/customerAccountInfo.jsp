...
<div id="center"
	...
	<%if(request.getAttribute("msg")=="yes"){ %>
	<table width="100%" height="350" border="0" align="center"
		cellpadding="0" cellspacing="0">

    <tr>
    <td align="top">
    <h3 align="center" class="style19">My Bank Accounts.</h3>
    <table border="1" align="center" height="37" width="90%" >
		...
		<tr align="top">
			...
			<td align="center" width="201"><span class="style4"><font face="Trebuchet MS" color="#0000FF">Branch</font></span></td>
			<td align="center" width="347">
			  <span class="style4"><font face="Trebuchet MS" color="#0000FF">Account Type</font></span></td>
		...
		<c:forEach var="customerAccount" items="${customerAccountList}" >
		   <tr>
				...
				<td align="center" width="171"><a href="${pageContext.request.contextPath}/customer/myAccountSummary/MiniStatement.htm"> Mini </a></td>
			</tr>
        </c:forEach>			
	</table>	
		</td>
	...
	<p align="center"><font size="3" color="red"><b>
			   Your Account Is Not Created,Contact Bank Manager!
			</b></font></p>
	<%} %>
</div>
</div>

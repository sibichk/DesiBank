...
<div id="header"><img
	...
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/customer/registeredPayees.htm">Change Password</a></li>
...
<form action="changePassword.htm" method="post">
	<table border="0" align="center">
		<tr>
			<td><b class="text1">Enter Your New Password: </b></td>
			<td>
			<strong><b><input  type="password" id="password" name="password" size="20" style="text1" /></b></strong></td>
		</tr>
